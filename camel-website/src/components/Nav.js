  ...
  return (
    <div>
      <nav className="flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[1%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
        <div  className="bg-background2 flex w-full xl:flex-col items-center justify-between xl:justify-center gap-y-8 px-4 md:px-40 xl:px-0 h-[30px] xl:h-max py-8 backdrop-blur-sm text-3xl xl:text-xl xl:rounded-full">
          ...
          {showPopup && (
            ...
            "
                ...
                {navData1.map((link, index) => (
                  <div
                    key={index}
                    className="p-1 hover-accent2 font-semibold text-primary-text hover:text-background hover:rounded-md text-center"
                  >
