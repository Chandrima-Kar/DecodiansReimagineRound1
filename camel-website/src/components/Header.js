  ...
  return (
    <div>
      <section id="home" className="  flex items-center">
        <div
          className="bg-background2 border-b-[1px]  border-accent w-full fixed pt-6 pb-2 mt-8 z-50 
          ...
          <div className="flex flex-col items-center justify-center w-full ">
            <div className="flex flex-row justify-between items-center w-full gap-x-14 md:gap-x-[5.5rem] xl:gap-x-60 mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-x-1 text-[1rem] sm:text-3xl font-bold">
                ...
                >
                  <h1 className=" text-accent">Camel</h1>
                  <img
                    src={camel_img}
                    alt="camel_image"
              ...
              <div className="flex items-center justify-center gap-x-2 md:gap-x-4">
                ...
                >
                  ...
                  text-[11px] md:text-[14px] xl:text-lg leading-none"
                  >
                    Find a store
                  </div>
                ...
                <Link to="/log-in">
                  <Button
                    text={"Log in"}
                    className={
                      "bg-background text-accent border-accent hover:bg-accent hover:text-background px-2 lg:px-5 py-1 text-[12px] md:text-[14px] xl:text-[16px]"
                    }
                  />
                </Link>
                <Link to="/sign-up">
                  <Button
                    text={"Sign up"}
                    className={
                      "bg-accent text-background border-background px-2 lg:px-5 py-1 text-[12px] md:text-[14px] xl:text-[16px]"
                    }
                  />
                </Link>
              </div>
