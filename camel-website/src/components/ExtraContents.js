...
const ThemeSettings = ({ colorTheme, onThemeChange, mode, onModeSwitch }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-50 bg-opacity-75 transition-all duration-700 transform ${
      ...
      >
        <div className="flex">
          ...
          <div
            className={`sm:w-2/5 md:w-1/3 lg:w-1/4 w-1/2 bg-[#585a5e] h-full shadow-lg flex flex-col gap-y-5 sm:gap-y-8 transition-transform duration-700 transform ${
