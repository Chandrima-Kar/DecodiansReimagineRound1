                ...
                <div className="grid md:grid-cols-3    sm:grid-cols-1 grid-cols-1  lg:gap-12 gap-8 sm:gap-10 ">
                  ...
                  {writeUps.map((content, index) => (
                    <motion.div
                      ...
                      whileInView="show"
                      key={index}
                      className={`w-[100%] my-0 mx-auto p-3 bg-background2 dark:bg-darkBackground2 border-2 border-accent rounded-[35px] xl:h-96 lg:h-80 md:h-72 sm:h-96 shadow-red flex flex-col items-center justify-center xl:p-8 lg:p-5 md:p-3.5 sm:px-4 hover:translate-y-4 transition-all duration-300 cursor-pointer ${
